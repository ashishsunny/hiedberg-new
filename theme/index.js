export default {
  ...
  colors: {
    text: '#041436', // body color and primary color
    text_secondary: '#041436', // secondary body color
    heading: '#7070F5', // primary heading 041436color
    heading_secondary: '#0F2137', // heading color
    background: '#E5F1FF', // body background color
    background_secondary: '#F9FBFD', // secondary background color
    border_color: '#E5ECF4', // border color
    primary: '#041436', // primary button and link color
    secondary: '#6566E3', // secondary color - can be used for hover states
...
//     secondary: '#ffb703', // secondary color - can be used for hover states
//     muted: '#7B8188', // muted color
//     accent: '#609', // a contrast color for emphasizing UI
//     yellow: '#F6C416',
