const Data = [
  {
    ...
    We pride ourselves in providing technical excellence, innovation, management, and value-for-money.`,
  },
  {
    id: 2,
    title: 'CONSULTING',
    ...
    Through our services, our clients can fine-tune their intervention strategies and project-steering methods to ensure their businesses and organisations succeed.`,
  },
  {
    id: 3,
    title: 'DEVELOPMENT',
  ...
  clients working in international development. \
  Our team shares a passion for developing systems and \
  structures and is dedicated to delivering tailor-made \
  solutions for every project and context in which we work. We \
  take a holistic approach in understanding our clients needs \
  to allow us to propose effective solutions to complex \
  organisational requirements. We develop and implement projects \
  at all levels from individual businesses to public sector \
  institutions.',
  }
];
